...
QT_MOC_LITERAL(3, 27, 12), // "setDemoColor"
QT_MOC_LITERAL(4, 40, 5) // "color"

    },
    "ColorChooser\0colorChanged\0\0setDemoColor\0"
    "color"
};
...
void ColorChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setDemoColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ColorChooser::*_t)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorChooser::colorChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ColorChooser::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ColorChooser.data,
...
// SIGNAL 0
void ColorChooser::colorChanged(QColor _t1)
{
